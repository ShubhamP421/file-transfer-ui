  ...
  return (
    <div className="relative min-h-screen text-zinc-200 flex flex-col items-center justify-center p-4 font-sans selection:bg-blue-500/30 overflow-hidden">
      ...
      {/* Interactive Waves Background 
        Positioned fixed to cover the screen, with z-0 so it stays behind everything.
      */}
      ...
      {/* Main Container - Notice the relative and z-10 classes */}
      <div className="w-full max-w-[420px] bg-[#0c0c0e]/80 backdrop-blur-xl border border-zinc-800/60 rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.6)] relative z-10 transition-all duration-500">
        
        <div className="pt-8 pb-4 px-8 text-center">
          <div className="flex justify-center mb-3">
            <div className="p-2.5 bg-blue-500/10 border border-blue-500/20 rounded-xl shadow-[0_0_15px_rgba(59,130,246,0.1)]">
      ...
      {/* Footer Status - Notice relative and z-10 classes */}
      <div className="mt-8 flex items-center gap-2 text-xs font-medium text-zinc-500 relative z-10 bg-zinc-950/50 px-4 py-2 rounded-full border border-zinc-800/50 backdrop-blur-sm">
